...
- 💬 **Discord**: [Join our community](https://discord.gg/meetmind)
- 🐛 **Issues**: [GitHub Issues](https://github.com/yourusername/meetmind/issues)
- 📚 **Documentation**: [Full API Docs](https://docs.meetmind.ai)
